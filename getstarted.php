...
echo '
        <div class="col-md-12 toptechdark">
            ...
            <div class="col-md-3">
                ...
                <h4 class="text-center">
                    <button type="button" class="btn btn-dark btn-md btnlinks" data-toggle="collapse"
                            data-target="#demo4"><span class="glyphicon glyphicon-phone"></span>
                    </button>
                </h4>
                <div id="demo4" class="collapse">
                    <h3 class="text-center text-info">0722 975 669</h3>
                </div>
                <h4 class="text-center"><a href="mailto:info@kisii.go">
                        <button class="btn btn-link btn-md btnlinks"><span class="glyphicon glyphicon-envelope"></span></button>
                    </a></h4>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-6">
                ...
                <p class="text-center">All Rights Reserved ' . $date . '</p>
                <hr/>
                <p class="text-muted text-center">Developed By <a href="https://tecksolke.com/" target="_blank" class="text-muted">TecksolKE</a></p>
            </div>
            <div class="col-md-3"></div>
        </div>';